...
export default function RunnerMainScreen({
  isBotMode, awaitingChatReady, isLoadingArchive, activeChatId,
  selectedUser, chatSessionKey, chatManager, botStoreMessages,
  botMessagesUpdater, registerSetMessages,
  botRefreshTrigger, handleNewOrderFleetSelected,
  handleStartNewOrder, newOrderTrigger,
  isVerifyingOtp, handleReturningUserChoice,
  isSubmitting, isVerified, active,text, setText, dark, setDark,
  isCollectingCredentials, credentialStep, credentialQuestions,
  needsOtpVerification, kycStatus, onIdVerified,
  registrationComplete, canResendOtp, sendMessage_fn,
  handleMessageClick, pickUp, runErrand, setDrawerOpen,
  setInfoOpen, initialMessagesComplete, runnerId, kycStep,
  handleIDTypeSelection, onSelfieVerified, handleSelfieResponse, handleBannedDetected,
  checkVerificationStatus, handleConnectToService, handleFindMore, nearbyUsers,
  handlePickService, runnerData, canShowNotifications, hasSearched,
  setBotReplyingTo, verificationState, showBannedModal, setShowBannedModal,
  effectiveReturningKycStatus, showNotifications,
  isConnectLocked, handleCredentialAnswer, runnerLocation, isReturningUser, returningUserData,
  onNotificationsShown, isTrainingCompleted, openTrainingContinueClick, onKycRedirect,
  chatMessagesUpdater, handleBackToHome,showOrderFlow, setShowOrderFlow, handleOrderStatusClick,
  setIsAttachFlowOpen, handleLocationClick, isAttachFlowOpen,
  handleAttachClick, handleSetCompletedStatuses,
  taskCompletedFromStore, completedStatusesFromStore,
}) {
  const {
